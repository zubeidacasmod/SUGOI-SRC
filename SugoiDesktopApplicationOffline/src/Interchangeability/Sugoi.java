...
difference between this and applet: define file entities in start and reset, disable jcheckbox1 in start and reset, disable 
email functionality
*/
...
public class Sugoi extends javax.swing.JApplet {
    ...
    private File sourceFoundationalOntologyFile;
    private File targetFoundationalOntologyFile;
    ...
    private void initComponents() {
        ...
        jPanel4Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel4Layout.createSequentialGroup()
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(jLabel25, javax.swing.GroupLayout.DEFAULT_SIZE, 0, Short.MAX_VALUE)
                    .addComponent(jLabel18, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 0, Short.MAX_VALUE)
                    .addComponent(jLabel21, javax.swing.GroupLayout.DEFAULT_SIZE, 0, Short.MAX_VALUE))
                .addContainerGap())
        );
                    ...
                    public Object visit(OWLNamedIndividual indiToWalk) {
                        ...
                        if( (!(sourceFoundationalOntology.containsIndividualInSignature(indiToWalk.getIRI()))) &&
                            ...
                            if( (toParse.isOfType(AxiomType.OBJECT_PROPERTY_ASSERTION)) || (toParse.isOfType(AxiomType.NEGATIVE_OBJECT_PROPERTY_ASSERTION))
                                 || (toParse.isOfType(AxiomType.DATA_PROPERTY_ASSERTION)) || (toParse.isOfType(AxiomType.NEGATIVE_DATA_PROPERTY_ASSERTION))   ){
    ...
    private void loadSourceAndTargetFoundationalOntologies() {
        ...
        if (sourceFileBool == true) {
            ...
            IRI map = IRI.create("");
                ...
                case 0 : 
                     sourceFoundationalOntologyFile = new File("InputFiles/Original/DOLCE-Lite.owl");
                     targetFoundationalOntologyFile= new File("InputFiles/Original/bfo-1.1.owl");
                     mapFile = new File("InputFiles/Mappings/DOLCE-LiteBFOMappings.owl");
                break;
                        
                case 1 :
                    sourceFoundationalOntologyFile = new File("InputFiles/Original/bfo-1.1.owl");
                     targetFoundationalOntologyFile= new File("InputFiles/Original/DOLCE-Lite.owl");
                     mapFile = new File("InputFiles/Mappings/DOLCE-LiteBFOMappings.owl");               
                break; 
                    
                case 2 :
                    sourceFoundationalOntologyFile = new File("InputFiles/Original/bfo-1.1.owl");
                     targetFoundationalOntologyFile= new File("InputFiles/Original/gfo.owl");
                     mapFile = new File("InputFiles/Mappings/BFOGFOMappings.owl");
                break; 
                    
                case 3 :
                    sourceFoundationalOntologyFile = new File("InputFiles/Original/gfo.owl");
                     targetFoundationalOntologyFile= new File("InputFiles/Original/bfo-1.1.owl");
                     mapFile = new File("InputFiles/Mappings/BFOGFOMappings.owl");
                break;
                ...
                case 4 :
                    sourceFoundationalOntologyFile = new File("InputFiles/Original/gfo.owl");
                     targetFoundationalOntologyFile= new File("InputFiles/Original/DOLCE-Lite.owl");
                     mapFile = new File("InputFiles/Mappings/DOLCE-LiteGFOMappings.owl");
                break;
                ...
                case 6 :
                    sourceFoundationalOntologyFile = new File("InputFiles/Original/DOLCE-Lite.owl");
                     targetFoundationalOntologyFile= new File("InputFiles/Original/BFORO.owl");
                     mapFile = new File("InputFiles/Mappings/BFORODOLCE-LiteMappings.owl");                     
                break;
                
                
                case 7 :
                    sourceFoundationalOntologyFile = new File("InputFiles/Original/BFORO.owl");
                     targetFoundationalOntologyFile= new File("InputFiles/Original/DOLCE-Lite.owl");
                     mapFile = new File("InputFiles/Mappings/BFORODOLCE-LiteMappings.owl");               
                break;
                ...
                case 8:
                    sourceFoundationalOntologyFile = new File("InputFiles/Original/BFORO.owl");
                     targetFoundationalOntologyFile= new File("InputFiles/Original/gfo.owl");
                     mapFile = new File("InputFiles/Mappings/BFOROGFOMappings.owl");                  
                break;                
                ...
                case 10 : 
                    sourceFoundationalOntologyFile = new File("InputFiles/Original/DOLCE-Lite.owl");
                     targetFoundationalOntologyFile= new File("InputFiles/Modules/gfo-basic.owl");
                     mapFile = new File("InputFiles/Mappings/DOLCE-LiteGFO-basicMappings.owl");
                break;
                                
                case 11 : 
                    sourceFoundationalOntologyFile = new File("InputFiles/Modules/gfo-basic.owl");
                     targetFoundationalOntologyFile= new File("InputFiles/Original/DOLCE-Lite.owl");
                     mapFile = new File("InputFiles/Mappings/DOLCE-LiteGFO-basicMappings.owl");                     
                break;                            
                  ...
                  case 12: 
                      sourceFoundationalOntologyFile = new File("InputFiles/Modules/gfo-basic.owl");
                     targetFoundationalOntologyFile= new File("InputFiles/Original/bfo-1.1.owl");
                     mapFile = new File("InputFiles/Mappings/BFOGFO-basicMappings.owl");
                break;                
                ...
                case 14: 
                    sourceFoundationalOntologyFile = new File("InputFiles/Modules/gfo-basic.owl");
                     targetFoundationalOntologyFile= new File("InputFiles/Original/BFORO.owl");
                     mapFile = new File("InputFiles/Mappings/BFOROGFO-basicMappings.owl");                     
                break;
                ...
                case 16: 
                    sourceFoundationalOntologyFile = new File("InputFiles/Modules/FunctionalParticipation.owl");
                     targetFoundationalOntologyFile= new File("InputFiles/Original/bfo-1.1.owl");
                     mapFile = new File("InputFiles/Mappings/FunctionalParticipationBFOMappings.owl");
                break;
                
                
                case 17:  
                     sourceFoundationalOntologyFile = new File("InputFiles/Original/bfo-1.1.owl");
                     targetFoundationalOntologyFile= new File("InputFiles/Modules/FunctionalParticipation.owl");
                     mapFile = new File("InputFiles/Mappings/FunctionalParticipationBFOMappings.owl");
                break;
                ...
                case 18: 
                    sourceFoundationalOntologyFile = new File("InputFiles/Modules/FunctionalParticipation.owl");
                     targetFoundationalOntologyFile= new File("InputFiles/Original/BFORO.owl");
                     mapFile = new File("InputFiles/Mappings/BFOROFunctionalParticipationMappings.owl");
                break;
                ...
                case 20: 
                    sourceFoundationalOntologyFile = new File("InputFiles/Modules/FunctionalParticipation.owl");
                     targetFoundationalOntologyFile= new File("InputFiles/Original/gfo.owl");
                     mapFile = new File("InputFiles/Mappings/FunctionalParticipationGFOMappings.owl");
                break;
                ...
                case 22: 
                    sourceFoundationalOntologyFile= new File("InputFiles/Modules/FunctionalParticipation.owl");
                    targetFoundationalOntologyFile = new File("InputFiles/Original/gfo-basic.owl");
                    mapFile = new File("InputFiles/Mappings/FunctionalParticipationGFO-basicMappings.owl");                
                break;
                    
                case 23: 
                    sourceFoundationalOntologyFile = new File("InputFiles/Original/gfo-basic.owl");
                     targetFoundationalOntologyFile= new File("InputFiles/Modules/FunctionalParticipation.owl");
                     mapFile = new File("InputFiles/Mappings/FunctionalParticipationGFO-basicMappings.owl");
                break;
                
                case 24: 
                    sourceFoundationalOntologyFile = new File("InputFiles/Modules/SpatialRelations.owl");
                     targetFoundationalOntologyFile= new File("InputFiles/Original/bfo-1.1.owl");
                     mapFile = new File("InputFiles/Mappings/SpatialRelationsBFOMappings.owl");
                break;
                
                case 25: 
                      sourceFoundationalOntologyFile = new File("InputFiles/Original/bfo-1.1.owl");
                     targetFoundationalOntologyFile= new File("InputFiles/Modules/SpatialRelations.owl");
                     mapFile = new File("InputFiles/Mappings/SpatialRelationsBFOMappings.owl");         
                break;
                ...
                case 26: 
                    sourceFoundationalOntologyFile = new File("InputFiles/Modules/SpatialRelations.owl");
                     targetFoundationalOntologyFile= new File("InputFiles/Original/BFORO.owl");
                     mapFile = new File("InputFiles/Mappings/BFOROSpatialRelationsMappings.owl");
                break;
                ...
                case 28: 
                    sourceFoundationalOntologyFile = new File("InputFiles/Modules/SpatialRelations.owl");
                     targetFoundationalOntologyFile= new File("InputFiles/Original/gfo.owl");
                     mapFile = new File("InputFiles/Mappings/SpatialRelationsGFOMappings.owl");                    
                break;
                ...
                case 30: 
                     sourceFoundationalOntologyFile = new File("InputFiles/Modules/SpatialRelations.owl");
                     targetFoundationalOntologyFile= new File("InputFiles/Modules/gfo-basic.owl");
                     mapFile = new File("InputFiles/Mappings/SpatialRelationsGFO-basicMappings.owl");
                break;
                ...
                case 32: 
                    sourceFoundationalOntologyFile = new File("InputFiles/Modules/TemporalRelations.owl");
                     targetFoundationalOntologyFile= new File("InputFiles/Original/bfo-1.1.owl");
                     mapFile = new File("InputFiles/Mappings/TemporalRelationsBFOMappings.owl");
                break; 
                    
                case 33: 
                      sourceFoundationalOntologyFile = new File("InputFiles/Original/bfo-1.1.owl");
                     targetFoundationalOntologyFile= new File("InputFiles/Modules/TemporalRelations.owl");
                     mapFile = new File("InputFiles/Mappings/TemporalRelationsBFOMappings.owl");
                break;
                ...
                case 34: 
                    sourceFoundationalOntologyFile = new File("InputFiles/Modules/TemporalRelations.owl");
                     targetFoundationalOntologyFile= new File("InputFiles/Original/BFORO.owl");
                     mapFile = new File("InputFiles/Mappings/BFOROTemporalRelationsMappings.owl");
                break;
                ...
                case 36: 
                    sourceFoundationalOntologyFile = new File("InputFiles/Modules/TemporalRelations.owl");
                     targetFoundationalOntologyFile= new File("InputFiles/Original/gfo.owl");
                     mapFile = new File("InputFiles/Mappings/TemporalRelationsGFOMappings.owl");
                ...
                case 38: 
                     sourceFoundationalOntologyFile = new File("InputFiles/Modules/TemporalRelations.owl");
                     targetFoundationalOntologyFile= new File("InputFiles/Modules/gfo-basic.owl");
                     mapFile = new File("InputFiles/Mappings/TemporalRelationsGFO-basicMappings.owl");                    
                break;
           ...
           jTextPane2.setText(jTextPane2Text);
            ...
            targetFoundationalOntology = managerFoundationalTarget.loadOntologyFromOntologyDocument(targetFoundationalOntologyFile);
            domainTargetOntology = managerDomainTarget.loadOntologyFromOntologyDocument(targetFoundationalOntologyFile);
            sourceFoundationalOntology = managerFoundationalSource.loadOntologyFromOntologyDocument(sourceFoundationalOntologyFile);            
            jTextPane2Text = jTextPane2Text + "Source foundational ontology file: " + sourceFoundationalOntologyFile + "\n\n";
            jTextPane2Text = jTextPane2Text + "Target foundational ontology file: " + targetFoundationalOntologyFile + "\n\n";
            jTextPane2Text = jTextPane2Text + "Mapping ontology file: " + mapFile + "\n\n"; 
            jTextPane2.setText(jTextPane2Text);
            jTextPane2.update(jTextPane2.getGraphics());
           ...
           // managerFoundationalSource.saveOntology(sourceFoundationalOntology);
...
//        countDownProgressBar();
    ...
    //jCheckBox1.setSelected(true);
    jCheckBox1.setEnabled(false);
    sourceFoundationalOntologyFile =null;
    targetFoundationalOntologyFile =null;
    mapFile = null;
